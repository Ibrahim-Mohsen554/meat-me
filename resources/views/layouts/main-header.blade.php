                        ...
                        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
                            ...
                            {{-- <a href="#" class="dropdown-item d-flex">
                                <span class="avatar  ml-3 align-self-center bg-transparent"><img
                                        src="{{ URL::asset('assets/img/flags/Egypt_Flag.svg') }}" alt="img"></span>
                                <div class="d-flex">
        ...
        <div class="dropdown nav-item main-header-message ">
            ...
            <div class="dropdown-menu">
                <div class="menu-header-content bg-primary text-right">
                    ...
                    <p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">You have 4 unread messages
                    </p>
                </div>
